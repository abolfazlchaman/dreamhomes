    ...
    <div className="w-full lg:px-[150px] px-5 flex flex-col items-center justify-center pt-8 pb-16 gap-10">
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="font-light text-[15px] text-gray-600 text-center">
          We are proud to be recognized for our excellence and trusted by numerous satisfied
          customers. Our dedication to quality has earned us industry awards and loyal clients.
        </p>
      </div>
